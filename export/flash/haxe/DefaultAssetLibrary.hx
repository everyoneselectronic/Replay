...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/simpleMap.csv", __ASSET__assets_simplemap_csv);
...
@:keep @:bind #if display private #end class __ASSET__assets_simplemap_csv extends flash.utils.ByteArray { }
...
@:file("assets/simpleMap.csv") #if display private #end class __ASSET__assets_simplemap_csv extends lime.utils.ByteArray {}
