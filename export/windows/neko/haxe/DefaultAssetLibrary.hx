...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/cave.png", AssetType.IMAGE);
		path.set ("assets/indoor.png", "assets/indoor.png");
		type.set ("assets/indoor.png", AssetType.IMAGE);
		path.set ("assets/outside.png", "assets/outside.png");
		type.set ("assets/outside.png", AssetType.IMAGE);
		...
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/indoor.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/outside.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/simpleMap.csv";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/sprites_small/sP1_carry0.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/sprites_small/sP1_carry1.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/sprites_small/sP1_down.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/sprites_small/sP1_punch.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/sprites_small/sP2_carry0.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/sprites_small/sP2_carry1.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/sprites_small/sP2_down.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/sprites_small/sP2_punch.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
