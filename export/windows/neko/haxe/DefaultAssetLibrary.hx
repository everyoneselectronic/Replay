...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		id = "assets/sprites/sP1_carry0.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/sprites/sP1_carry1.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/sprites/sP1_down.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/sprites/sP1_punch.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/sprites/sP2_carry0.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/sprites/sP2_carry1.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/sprites/sP2_down.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
