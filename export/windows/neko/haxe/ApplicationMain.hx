...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "Replay", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Replay";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Replay", null, { width: 1025, height: 775 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 1025, height: 775 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 1025, 775, "null");
		#end
		#else
		create ();
		#end
